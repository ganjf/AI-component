...
def cal_CI(binary_label_file='binary_label_FL.pkl', pred_probs_file='pred_probs_FL.pkl'):
...
def cal_pvalue(binary_label_file='binary_label_FL.pkl', pred_probs_file='pred_probs_FL.pkl'):
    with open(binary_label_file, 'rb') as f:
        binary_label = pickle.load(f)
    with open(pred_probs_file, 'rb') as f:
        pred_probs = pickle.load(f)
